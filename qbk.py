...
def proxymode():
	global choice2
	choice2 = input("proxy/socks Answer 'y': ")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("Type '0' enable '1' socksmode: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("New list of proxy? Answer 'y' : ")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("New list of socks? Answer 'y' : ")
	if choice4 == "y":
...
def multiplication():
	global multiple
	try:
		multiple = int(input("Insert attack [(1-5=normal)(50=powerful)(100 or more=bomb)]: "))
	except ValueError:
		print("You mistyped, try again.\n")
		multiplication()
	begin()
